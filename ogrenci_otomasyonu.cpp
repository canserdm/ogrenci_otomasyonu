...
int main(){
	...
	cout<<" 5. Cikis"<<endl;
	cout<<"------------------------------"<<endl;
	cout<<"\nModul Seciniz: ";									//islem yapilacak modulun secimi yapýlýyor
	cin>>secim;
	switch(secim){
		case 1: goto ogr_mdl;					//ana menuden ogrenci modulune gönderiliyor
		case 2: goto ogr_el_mdl;				//ana menuden ogretim elemaný modulune gönderiliyor
	...
	ogr_mdl:
		don:
		system("cls");
		cout<<"\n-----------OGRENCI MODULU---------"<<endl;		//Ogrenci modulunde yapýlmak istenen islemler menu halinde olusturuluyor
		...
		switch(secim){
			...
			case 1:	
				...
				cout<<"\nOgrencinin Numarasi: ";	cin>>ogr_no;		//ogrencinin bilgileri kullanýcý tarafýndan giriliyor
				cout<<"Adi: ";	cin>>ad;
				cout<<"Soyadi: ";	cin>>soyad;
				cout<<"Bolum: ";	cin>>bolum;
				cout<<"Sinifi: ";	cin>>sinif;
				
				yazma<<"\n"<<ogr_no;					//Ogrenci bilgileri dosyaya yazdýrýlýyor
				yazma<<"\t"<<ad;  
				yazma<<"\t"<<soyad;
				yazma<<"\t"<<bolum;
				yazma<<"\t"<<sinif;
				...
				cin>>secim2;
				if(secim2=='e'||secim2=='E')	goto kayit;						//tekrar kayit yapilmak istendiðinde kayit etiketinin olduðu satirdan devam ediyor
					else if(secim2=='h'||secim2=='H')	goto don;			//kayit yapilmak istenmediðinde ana menuye donuyor
			...
			case 2:
				...
				while(secim==1){
    				...
    				okuma.open("ogrenci.txt",ios::app);//arama yapýlacak dosya ismi
    				if(!okuma.is_open()){
					...
					cin>>secim2;
					if(secim2=='e'||secim2=='E')	goto arama;						//tekrar arama yapilmak istendiðinde arama etiketinin olduðu satirdan devam ediyor
						else if(secim2=='h'||secim2=='H')	goto don;			//arama yapilmak istenmediðinde ana menuye donuyor
							else {															//yanlis secim yapildiginda tekrar secim yaptiriliyor
								cout<<"\a\tYanlis secim yaptiniz!\n\tLutfen tekrar deneyin!" ;   
								goto tekrar1;
							}
			...
			case 3:	
				...
				while(secim==1){
					...
					cout<<"\nTekrar arama yapmak ister misiniz?(e/h): ";				
					cin>>secim2;
					if(secim2=='e'||secim2=='E')	goto listele;						//tekrar arama yapilmak istendiðinde arama etiketinin olduðu satirdan devam ediyor
						else if(secim2=='h'||secim2=='H')	goto don;			//arama yapilmak istenmediðinde ana menuye donuyor
							else {															//yanlis secim yapildiginda tekrar secim yaptiriliyor
								cout<<"\a\tYanlis secim yaptiniz!\n\tLutfen tekrar deneyin!" ;   
								goto tekrar3;
	...
	ogr_el_mdl:	
		don2:
		system("cls");
		cout<<"\n-----------OGRETIM ELEMANI MODULU---------"<<endl;		//Ogretim elemani modulunde yapýlmak istenen islemler menu halinde olusturuluyor
		...
		cout<<" 4. Ana Menuye Don"<<endl;
		cout<<"----------------------------------"<<endl;
		cout<<"\nYapmak istediginiz islemi seciniz: ";					//ogretim elemaný modulunde yapilmak istenen islem seciliyor
		cin>>secim;
		switch(secim){
			case 4:	goto baslangic;
			case 1:	
				...
				cout<<"\nsicil numarasi: ";	cin>>sicil_no;		//ogrencinin bilgileri kullanýcý tarafýndan giriliyor
				cout<<"Adi: ";	cin>>ogrt_ad;
				cout<<"Soyadi: ";	cin>>ogrt_soyad;
				cout<<"Bolum: ";	cin>>ogrt_bolum;
				
				yazma<<"\n"<<sicil_no;					//Ogrenci bilgileri dosyaya yazdýrýlýyor
				yazma<<"\t"<<ogrt_ad;  
				yazma<<"\t"<<ogrt_soyad;
				yazma<<"\t"<<ogrt_bolum;
				cout<<"Kayit yapilmistir.";
				...
				cout<<"\nbaska kayit yapmak ister misiniz?(e/h): ";				
				cin>>secim2;
				if(secim2=='e'||secim2=='E')	goto kayit2;						//tekrar kayit yapilmak istendiðinde kayit etiketinin olduðu satirdan devam ediyor
					else if(secim2=='h'||secim2=='H')	goto don2;			//kayit yapilmak istenmediðinde ana menuye donuyor
						else {															//yanlis secim yapildiginda tekrar secim yaptiriliyor
							cout<<"\a\tYanlis secim yaptiniz!\n\tLutfen tekrar deneyin!" ;   
							goto tekrar5;
						}
			...
			case 2:
    				...
    				okuma.open("ogretim_elemani.txt",ios::app);//arama yapýlacak dosya ismi
    				if(!okuma.is_open()){
						cerr << "HATA: BOYLE BIR DOSYA MEVCUT DEGIL!" << endl;   
      					abort();
					}
					...
					cout<<"\ntekrar arama yapmak ister misiniz?(e/h): ";				
					cin>>secim2;
					if(secim2=='e'||secim2=='E')	goto arama2;						//tekrar arama yapilmak istendiðinde arama etiketinin olduðu satirdan devam ediyor
						else if(secim2=='h'||secim2=='H')	goto don2;			//arama yapilmak istenmediðinde ana menuye donuyor
							else {															//yanlis secim yapildiginda tekrar secim yaptiriliyor
								cout<<"\a\tYanlis secim yaptiniz!\n\tLutfen tekrar deneyin!" ;   
								goto tekrar6;
							}	
			...
			case 3:
				...
				cout<<"\n---------Ogretim Elemani listeleme---------"<<endl;
					...
					cout<<"\nTekrar listeleme yapmak ister misiniz?(e/h): ";				
					cin>>secim2;
					if(secim2=='e'||secim2=='E')	goto listele1;						//tekrar arama yapilmak istendiðinde arama etiketinin olduðu satirdan devam ediyor
						else if(secim2=='h'||secim2=='H')	goto don2;			//arama yapilmak istenmediðinde ana menuye donuyor
							else {															//yanlis secim yapildiginda tekrar secim yaptiriliyor
								cout<<"\a\tYanlis secim yaptiniz!\n\tLutfen tekrar deneyin!" ;   
								goto tekrar7;
	...
	ders_mdl:	
		don3:
		system("cls");
		cout<<"\n-----------DERS MODULU---------"<<endl;		//Ogrenci modulunde yapýlmak istenen islemler menu halinde olusturuluyor
		...
		switch(secim){
			...
			case 1:	
				...
				cout<<"\nDers kodu: ";	cin>>kod;		//ogrencinin bilgileri kullanýcý tarafýndan giriliyor
				cout<<"Dersin adi: ";	cin>>ders_ad;
				
				yazma<<"\n"<<kod;					//Ogrenci bilgileri dosyaya yazdýrýlýyor
				yazma<<"\t"<<ders_ad;
				cout<<"Kayit yapilmistir.";
				...
				cin>>secim2;
				if(secim2=='e'||secim2=='E')	goto kayit9;						//tekrar kayit yapilmak istendiðinde kayit etiketinin olduðu satirdan devam ediyor
					else if(secim2=='h'||secim2=='H')	goto don3;			//kayit yapilmak istenmediðinde ana menuye donuyor
						else {															//yanlis secim yapildiginda tekrar secim yaptiriliyor
							cout<<"\a\tYanlis secim yaptiniz!\n\tLutfen tekrar deneyin!" ;   
							goto tekrar9;
						}
			...
			case 2:
    				...
    				okuma.open("ders.txt",ios::app);//arama yapýlacak dosya ismi
    				if(!okuma.is_open()){
						cerr << "HATA: BOYLE BIR DOSYA MEVCUT DEGIL!" << endl;   
      					abort();
					}
					...
					cout<<"\ntekrar arama yapmak ister misiniz?(e/h): ";				
					cin>>secim2;
					if(secim2=='e'||secim2=='E')	goto arama3;						//tekrar arama yapilmak istendiðinde arama etiketinin olduðu satirdan devam ediyor
						else if(secim2=='h'||secim2=='H')	goto don3;			//arama yapilmak istenmediðinde ana menuye donuyor
							else {															//yanlis secim yapildiginda tekrar secim yaptiriliyor
								cout<<"\a\tYanlis secim yaptiniz!\n\tLutfen tekrar deneyin!" ;   
								goto tekrar10;
							}	
	...
	not_grs_mdl:
		don4:
		system("cls");
		cout<<"\n-----------NOT GIRIS MODULU---------"<<endl;		//Ogrenci modulunde yapýlmak istenen islemler menu halinde olusturuluyor
		...
		switch(secim){
					...
					for(l=0;l<4;l++){
						if(no==dizi[k][l]){
							...
							for(l=0;l<4;l++){
								...
								cin>>secim2;
								if(secim2=='e'||secim2=='E')	goto gir;						//tekrar arama yapilmak istendiðinde arama etiketinin olduðu satirdan devam ediyor
									else if(secim2=='h'||secim2=='H')	goto don4;			//arama yapilmak istenmediðinde ana menuye donuyor
										else {															//yanlis secim yapildiginda tekrar secim yaptiriliyor
											cout<<"\a\tYanlis secim yaptiniz!\n\tLutfen tekrar deneyin!" ;   
											goto tekrar13;
										}	
					...
					for(l=0;l<4;l++){
						if(no==dizi[k][l]){
							...
							for(l=0;l<4;l++){
								...
								cin>>secim2;
								if(secim2=='e'||secim2=='E')	goto gir2;						//tekrar arama yapilmak istendiðinde arama etiketinin olduðu satirdan devam ediyor
									else if(secim2=='h'||secim2=='H')	goto don4;			//arama yapilmak istenmediðinde ana menuye donuyor
										else {															//yanlis secim yapildiginda tekrar secim yaptiriliyor
											cout<<"\a\tYanlis secim yaptiniz!\n\tLutfen tekrar deneyin!" ;   
											goto tekrar14;
			...
			case 3:
				...
				cout<<"\n---------Ogrenci Ders listeleme---------"<<endl;
    				...
    				okuma.open("ders_ekleme.txt",ios::app);//arama yapýlacak dosya ismi
    				if(!okuma.is_open()){
						cerr << "HATA: BOYLE BIR DOSYA MEVCUT DEGIL!" << endl;   
      					abort();
					}
			...
			case 4:	
				...
				cout<<"\n---------Ogrenci Karnesi---------"<<endl;
    				...
    				okuma.open("notlar.txt",ios::app);//arama yapýlacak dosya ismi
    				if(!okuma.is_open()){
						cerr << "HATA: BOYLE BIR DOSYA MEVCUT DEGIL!" << endl;   
      					abort();
					}
